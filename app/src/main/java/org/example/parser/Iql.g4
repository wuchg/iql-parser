...
expr
 ...
 | K_NOT* (field | STRING_LITERAL) operator ( literal_value | literal_list | function ) ordering_term?
 ;
...
function
: function_name OPEN_PAR (function_param (COMMA function_param)*)? CLOSE_PAR
;
...
FN_SUM : S U M;
FN_COUNT : C O U N T;
FN_STARTOFWEEK : S T A R T O F W E E K;
